...
public class PahoMqttClient {
        ...
        try {
            ...
            token.setActionCallback(new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    Log.d(TAG, "onSuccess: Mqtt Connection Successful");
                    displayToast("Mqtt Connection Successful");
                }

                @Override
                public void onFailure(IMqttToken asyncActionToken, Throwable exception) {
                    Log.d(TAG, "onFailure: Mqtt Connection Failed");
                    displayToast("Mqtt Connection Failed");
                }
            });
    ...
    private MqttConnectOptions getMqttConnectionOption() {
        ...
        mqttConnectOptions.setPassword(Constants.pwd.toCharArray());
    ...
    public void subscribe(@NonNull MqttAndroidClient client, @NonNull final String topic, int qos) throws MqttException {
        ...
        token.setActionCallback(new IMqttActionListener() {
            @Override
            public void onSuccess(IMqttToken iMqttToken) {
                Log.d(TAG, "onSuccess: Subscribe Successfully" + topic);
                //displayToast("Subscribe Successfully " + topic);
            }
   ...
   public void displayToast(String s){
       Toast.makeText(MainActivity.mContext , s, Toast.LENGTH_SHORT).show();
   }
